...
import { createTicketComment, getTicket, getTicketComments, getTicketHistory, updateTicket, type TicketComment, type TicketHistory, type TicketPriority, type TicketResponse, type TicketStatus } from "@/lib/api";
